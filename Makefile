...
GO_LD_FLAGS += -X github.com/prometheus/common/version.Version=$(RELEASE)
GO_LD_FLAGS += -X github.com/prometheus/common/version.Revision=$(REVISION)
GO_LD_FLAGS += -X github.com/prometheus/common/version.Branch=$(BRANCH)
GO_LD_FLAGS += -X github.com/prometheus/common/version.BuildUser=$(USER)
